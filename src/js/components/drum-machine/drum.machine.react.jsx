	...
	render() {
		...
		return (
			...
			<div className="channels">
				...
				<Channel>
					<Rotator name="Tempo" value={tempo.beatsPerMinute} onKnobRotate={ (amount) => tempoActions.changeBPMByAmount(amount) } onValueChange={ (value) => tempoActions.changeBPM(value) } />
				</Channel>
			</div>
			<div className="channels">
