...
export default function configureStore(initialState) {
	let createStoreWithMiddleware = applyMiddleware(supplyAudioContext, supplyAudioNodes, updateAudioParams, supplySoundBuffers, sequencer(), createBuffer)(createStore);
